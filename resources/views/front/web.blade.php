...
<section class="voice">
  <div class="container d-flex flex-wrap">
    <div class="left col-12 col-sm-12 col-md-12 col-lg-6 d-flex justify-content-center">
      <img src="image/pexels-photo-10415146 1 (2).png" alt="" width="100%" height="fit-content">
    </div>
...
<section class="how-do" style="padding: 60px 0;">
  <div class="container d-flex flex-wrap justify-content-center">
    ...
    <div class="right col-12 col-sm-12 col-md-12 col-lg-6 d-flex justify-content-center align-items-center">
      <img src="image/Web design (1).png" alt="" width="100%">
    </div>
  </div>
</section>
    ...
    <div class="cont-programs">
      <div class="card" style="width: 18rem;">
        <div class="card-header">
            <img src="image/laravel.png" class="card-img-top" alt="..." width="25px" height="80px">
        </div>
        <div class="card-body">
      ...
      <div class="card" style="width: 18rem;">
        <div class="card-header">
            <img src="image/Node Js.png" class="card-img-top" alt="..." width="40px" height="80px">
        </div>
        <div class="card-body">
          ...
          <div class="swiper-slide">
            <div class="card" style="width: 18rem;">
              <div class="card-header" style="padding: 20px 10px;">
                  <img src="image/Group 11098.png" class="card-img-top" alt="...">
              </div>
              <div class="card-body">
