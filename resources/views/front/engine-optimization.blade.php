...
<section class="engine-card">
  <div class="container ">
    <div class="card d-flex flex-row flex-wrap">
      ...
      <span class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="img-down">
            <img src="image/Search Engine (1).png" alt="">
        </div>
        <p>See your idea come to life</p>
      </span>
    </div>
...
<section class="how-do" style="padding: 60px 0;">
  <div class="container d-flex flex-wrap">
    ...
    <div class="right col-12 col-sm-12 col-md-12 col-lg-6 d-flex align-items-center">
      <img src="image/Search engine optimization.png" alt="" width="100%">
    </div>
  </div>
</section>
...
<section class="engine" style="padding: 50px;">
  <div class="container">
    <h2>programs that we use</h2>
    <p>We are always excited to hear about great ideas and help turn them into a successful project</p>
    <div class="cont-programs">
      <div class="card" style="width: 18rem;">
        <div class="card-header">
            <img src="image/google shopping.png" class="card-img-top" alt="..." width="60px" height="60px">
        </div>
        <div class="card-body">
      ...
      <div class="card" style="width: 18rem;">
        <div class="card-header">
            <img src="image/Rectangle (1).png" class="card-img-top" alt="..." width="60px" height="60px">
        </div>
        <div class="card-body">
      ...
      <div class="card" style="width: 18rem;">
        <div class="card-header">
            <img src="image/Rectangle (2).png" class="card-img-top" alt="..." width="60px" height="60px">
        </div>
        <div class="card-body">
          <h5 class="card-title">Adobe Audition</h5>
          <p class="card-text">Lorem ipsum dolor sit amet,
      ...
      <div class="card" style="width: 18rem;">
        <div class="card-header">
            <img src="image/Google.png" class="card-img-top" alt="..." width="60px" height="60px">
        </div>
        <div class="card-body">
          <h5 class="card-title">Adobe Audition</h5>
          <p class="card-text">Lorem ipsum dolor sit amet,
